...
import api2 from '../servicios/apia1';
...
class Listar extends React.Component {
    ...
    aprobarRegistros=(IdPago)=> {
        console.log(IdPago);
        
        fetch(api2+"/?aprobar1="+IdPago)
        .then(respuesta=>respuesta.json())
        .then((datosRespuesta)=>{
...
<h4>Lista de aprobacion de pagos</h4>
                ...
                (empleado)=>(
                    ...
                    <td>
                        <div className="btn-group" role="group" aria-label="">
                            ...
                            >Editar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                            ...
                            onClick={()=>this.borrarRegistros(empleado.IdPago)}
                            ...
                            onClick={()=>this.aprobarRegistros(empleado.IdPago)}
                            
                            >Aprobar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
